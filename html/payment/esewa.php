...
<!-- Main Content -->
    <p class="intro">Esewa Mobile Wallet</p>
    <div class="container">
        <div class="payments">
            <div class="esewa">
                <a href=""><img src="../../svgs/esewa-seeklogo.com.svg" alt=""></a>
                <p>Esewa Wallet</p>
            </div>
    </div>
   </div>
   <div class="form-section">
    <div class="esewa-id">
        <input type="text" name="id" id="" placeholder="Esewa Id">
    </div>
    <div class="esewa-name">
        <input type="text" name="name" id="" placeholder="Esewa Username">
    </div>
    <div class="pay">
